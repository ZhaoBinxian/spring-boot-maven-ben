...
public class ImmutablePrimitiveWrapperWithDefaultsProperties {
    ...
    public ImmutablePrimitiveWrapperWithDefaultsProperties(@DefaultValue("true") Boolean flag,
                                                           @DefaultValue("120") Byte octet,
                                                           @DefaultValue("a") Character letter,
                                                           @DefaultValue("1000") Short number,
                                                           @DefaultValue("42") Integer counter,
                                                           @DefaultValue("2000") Long value,
                                                           @DefaultValue("0.5") Float percentage, @DefaultValue("42" +
            ".42") Double ratio) {
        this.flag = flag;
        this.octet = octet;
        this.letter = letter;
