 ...
 */
abstract class AbstractHealthEndpointAdditionalPathIntegrationTests<T extends AbstractApplicationContextRunner<T, C,
        A>, C extends ConfigurableApplicationContext, A extends ApplicationContextAssertProvider<C>> {
    ...
    void groupIsAvailableAtAdditionalPathOnManagementPort() {
        this.runner.withPropertyValues("management.endpoint.health.group.live.include=diskSpace",
                        "management.server.port=0", "management.endpoint.health.group.live" +
                                ".additional-path=management:healthz",
                        "management.endpoint.health.group.live.show-components=always")
