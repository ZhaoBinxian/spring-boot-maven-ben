...
class Saml2RelyingPartyAutoConfigurationTests {
    ...
    private String[] getPropertyValuesWithoutSigningCredentials(boolean signRequests) {
        return new String[]{PREFIX
                + ".foo.identityprovider.singlesignon.url=https://simplesaml-for-spring-saml.cfapps" +
                ".io/saml2/idp/SSOService.php",
                PREFIX + ".foo.identityprovider.singlesignon.binding=post",
                PREFIX + ".foo.identityprovider.singlesignon.sign-request=" + signRequests,
                PREFIX + ".foo.identityprovider.entity-id=https://simplesaml-for-spring-saml.cfapps" +
                        ".io/saml2/idp/metadata.php",
                PREFIX + ".foo.identityprovider.verification.credentials[0]" +
                        ".certificate-location=classpath:saml/certificate-location"};
    }
    ...
    private String[] getPropertyValues() {
        return new String[]{
                ...
                PREFIX + ".foo.identityprovider.singlesignon.url=https://simplesaml-for-spring-saml.cfapps" +
                        ".io/saml2/idp/SSOService.php",
                PREFIX + ".foo.identityprovider.singlesignon.binding=post",
                PREFIX + ".foo.identityprovider.singlesignon.sign-request=false",
                PREFIX + ".foo.identityprovider.entity-id=https://simplesaml-for-spring-saml.cfapps" +
